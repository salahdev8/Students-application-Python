...
class StudentAnnouncements(tk.Frame):
    ...
    def show_courses(self):
        ...
        tk.Spinbox(self.operationsFrame, fg="blue", font=12, textvariable=self.CourseName, values=courseslist).grid(
            column=1, row=3)
        tk.Button(self.operationsFrame, text="announcements",command=self.show_announcements,
    ...
    def show_announcements(self):
        ...
        tk.Label(self.operationsFrame, text="Announcement").grid(column=1, row=4)

        j=5
        i = 0
        while (i < len(announcements)):
            tk.Label(self.operationsFrame, text=announcements[i][0]).grid(column=0, row=j)
            tk.Label(self.operationsFrame, text=announcements[i][1]).grid(column=1, row=j)
            i += 1
            j +=1
