...
class StudentAssignment(tk.Frame):

    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)

        self.CourseName = tk.StringVar()
        self.HomeworkFiles = tk.StringVar()
    ...
    def next_step(self):
        ...
        tk.Spinbox(self.operationsFrame, fg="blue", font=12, textvariable=self.HomeworkFiles, values=result).grid(
            column=1, row=1)
